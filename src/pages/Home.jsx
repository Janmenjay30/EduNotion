            ...
            <div className="bg-pure-greys-5 text-richblack-700">
                ...
                <div className="mx-auto w=11/12 max-w-maxContent flex flex-col items-center justify-between gap-7 pb-[130px]">
                        <div className="flex flex-row gap-5 mb-10 mt-[95px]">
                            <div className="text-4xl font-semibold w-[45%]">Get the skills you need for a job <div className="text-bold bg-gradient-to-r from-[#5433FF] via-[#20BDFF] to-[#A5FECB]  text-transparent bg-clip-text">Job that is in demand</div></div>
